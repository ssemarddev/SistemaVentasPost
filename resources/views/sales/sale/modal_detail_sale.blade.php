<!-- Modal -->
<div class="modal fade" id="detalleSaleModal" tabindex="-1" aria-labelledby="detalleSaleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="detalleSaleLabel">Detalle de la venta</h5>
